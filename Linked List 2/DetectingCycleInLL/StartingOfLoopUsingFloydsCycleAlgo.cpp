...
// to find the starting of the loop in Floyd's cycle detection algo, first we find the node where slow and fast pointer converge 
// next, we reset the slow pointer to head again 
// and move both slow and fast pointers by same pace i.e. one step at a time 
// now they will converge at the start node of the loop
