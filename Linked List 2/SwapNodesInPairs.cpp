...
// given a linked list, swap the nodes of the linked list in pairs
// don't overwrite the numbers, modify the links
...
Node* swapNodeinPairs(Node* head){
