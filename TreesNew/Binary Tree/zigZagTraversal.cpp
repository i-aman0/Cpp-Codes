...
vector<int> zigZag(node* root){
    ...
    // boolean variable for checking whether it is time for left to right or right to left traversal
    ...
    while(!q.empty()){
        ...
        for(int i=0;i<size;i++){
            ...
            // calculating the index on which to store the data in the vector based on the value of leftToRight
            // if leftToRight is true store the value on normal index and if it false, store the value in reverse index 
        ...
        // after every level, change the direction of traversal
...
int main()
{
    ...
    cout<<"The zig-zag traversal of the tree is : "<<endl;
    for(auto i: ans){
        cout<<i<<" ";
    }
