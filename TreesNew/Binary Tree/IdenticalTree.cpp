...
// we check if two trees are identical 
bool identical(node* r1, node* r2){
    ...
    // recursive call to left of the tree to check if the left subtree is identical
    bool left=identical(r1->left, r2->left);

    // recursive call to right part of the tree
